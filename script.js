document.addEventListener("DOMContentLoaded", function () {
    ...
    function verifyCaptcha(){
        ...
        captchaStatus.style.color = "red";
            ...
            captchaStatus.textContent ="Incorrect captcha! try again!"
            captchaStatus.style.color = "red";
        }
        setTimeout(()=>{
        ...
        inputText.value = "";
        captchaText.value = generateCaptchaText(6);
        drawcaptcha(captchaText);
    }
    ...
    function drawCaptcha(text){
        ...
        const startX = (camvas.width - textWidth)/3;

        for (let i = 0; i<text.length; i++){
            ctx.save();
            ctx.translate(start + i*20, 30);
